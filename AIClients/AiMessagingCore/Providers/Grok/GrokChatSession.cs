...
public sealed class GrokChatSession : ChatSessionBase
{
    private static readonly HttpClient HttpClient = new();

    public GrokChatSession(ChatSessionOptions options) : base(options) { }
        ...
        [System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        var baseUrl = Environment.GetEnvironmentVariable("XAI_BASE_URL") ?? "https://api.x.ai/v1";
